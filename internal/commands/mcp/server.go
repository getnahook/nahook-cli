...
//
// Content lives in INSTRUCTIONS.md so it's editable as markdown (syntax
// highlighting, no string-escape friction) and reviewable by anyone who
// can read English, not just Go.
//
